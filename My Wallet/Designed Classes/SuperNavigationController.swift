...
class SuperNavigationController {
    static func setTitle(title : String, nv: UIViewController){
        ...
        nv.navigationController?.navigationBar.largeTitleTextAttributes = [NSAttributedString.Key.font: UIFont(name: "JF Flat", size: 32)!, NSAttributedString.Key.foregroundColor: UIColor.white]
